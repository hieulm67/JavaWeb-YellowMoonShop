 ...
 * @author MinHiu
 */
@WebServlet(name = "LoadUpdatePageServlet", urlPatterns = {"/LoadUpdatePageServlet"})
public class LoadUpdatePageServlet extends HttpServlet {

    static Logger log = Logger.getLogger(LoadUpdatePageServlet.class.getName());

    final String UPDATE_CAKE_PAGE = "updateCakePage";
	...
	String url = siteMap.get(UPDATE_CAKE_PAGE);
